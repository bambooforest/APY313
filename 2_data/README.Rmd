...
* Vector: an ordered collection of the same basic data types, i.e., 1-dimension of homogeneous data types
...
We will learn more about accessing and manipulating vectors and data frames in the lecture on [data wrangling](../4_data_wrangling/README.md).
...
A useful function for looking up commands is `help.search()`, where you can search on a keyword within the parentheses.
